...
| ~~6~~ | ~~**Preflight y panel de estado**~~ ✅ **v5.56.0** | ~~UXF-001~~, ~~UXF-002~~, ~~UXF-008~~, ~~UXF-005~~, ~~FUN-001~~ | `PreflightGeneracionUseCase`; vista «Estado del curso» como pantalla de arranque; motivo de bloqueo visible; modo local | P1 | medio | M | 3 | `test_guardarrailes_flujo.py` sin xfail (12 tests) ✅. GP-1 baja de 6 a 5 clics; llegar a 3 es UXF-003, del lote 10 | **completado** |
...
2. **Lote 8** (sistema de diseño base, VIS-001/002/003/009 + UXA-010) — el siguiente frente natural, con las decisiones ya tomadas: azul `#0E5FA8` y tipografía del sistema. Es esfuerzo L y riesgo alto porque toca todas las superficies, pero los ratchets de `test_consistencia_visual_ratchet.py` dan la medida objetiva de si mejora o empeora.
3. **Lote 7** (refresco de curso y estado sucio, UXA-004/007 + UXF-004) — más pequeño, y ahora que existe el preflight buena parte del refresco ya está encaminada.
