...
| 10 | **Clics y caminos dorados** | ~~UXF-006~~, ~~UXF-010~~, ~~UXF-011~~, UXF-003, UXF-009 | Carpeta recordada en los cuatro diálogos; jerarquía entre Generar y Limpiar; Ctrl+1…Ctrl+0 anunciados en el menú. Quedan UXF-003 (bajar GP-1 de 5 a 3 clics: resumen en línea y cierre automático del progreso) y UXF-009 (deshacer en ausencias) | P2 | bajo | M | 9 | `test_flujo_y_atajos.py` (9 tests) ✅ | **parcial v5.70.0** |
