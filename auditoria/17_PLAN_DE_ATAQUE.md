...
| 9 | **Componentes y feedback** | ~~VIS-006~~, ~~VIS-007~~, ~~UXA-003~~, ~~UXA-013~~, VIS-008 (parcial), VIS-004, VIS-005 | Cabecera única de vista; jerarquía de botones escrita; avisos accesibles y errores que no desaparecen solos. **Quedan VIS-004 (emojis como iconos, 324 líneas) y VIS-005 (terminal retro para resultados), que son decisiones de aspecto y conviene consultarlas antes** | P2 | medio | L | 8 | `test_componentes_y_feedback.py` (9 tests) ✅ | **parcial v5.72.0** |
