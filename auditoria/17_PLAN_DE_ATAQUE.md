...
2. **Lote 6** (preflight y panel de estado, UXF-001/002/008 + FUN-001) — ya sin bloqueos, ahora que el lote 3 está hecho. Es lo que convierte la aplicación en algo guiado en vez de una rejilla de botones.
3. **Lote 8** (sistema de diseño base) — independiente de todo lo anterior y con las decisiones ya tomadas: azul `#0E5FA8` y tipografía del sistema.
