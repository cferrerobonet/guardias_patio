...
def create_sftp_tab(dialog) -> QWidget:
    ...
    dialog.sftp_host_input.setAccessibleName("Campo servidor SFTP")
    ...
    dialog.sftp_port_input.setAccessibleName("Campo puerto SFTP")
    ...
    dialog.sftp_user_input.setAccessibleName("Campo usuario SFTP")
    ...
    dialog.sftp_password_input.setAccessibleName("Campo contraseña SFTP")
    ...
    dialog.sftp_basedir_input.setAccessibleName("Campo directorio base SFTP")
...
def create_smtp_tab(dialog) -> QWidget:
    ...
    dialog.smtp_server_input.setAccessibleName("Campo servidor SMTP")
    ...
    dialog.smtp_port_input.setAccessibleName("Campo puerto SMTP")
    ...
    dialog.smtp_user_input.setAccessibleName("Campo usuario SMTP")
    ...
    dialog.smtp_password_input.setAccessibleName("Campo contraseña SMTP")
    ...
    dialog.smtp_from_name_input.setAccessibleName("Campo nombre remitente SMTP")
